...
def get_playcounts_threaded(track_list, workers=4):
    user_playcount_dict = {}
...
def get_playlist_playcounts(playlist):
    ...
    pylast_tracks = [SmartifyTrack(network=network, lastfm_username=lastfm_username, **track.__dict__) for track in playlist]
